...
- อ่านผล 11 พารามิเตอร์จากภาพแผ่นตรวจพร้อมตารางสีผู้ผลิต
- ปฏิเสธผลที่อ่านไม่ครบหรือระบุตำแหน่งแถบไม่ได้
- วัด RGB จากพิกเซลในบริเวณแถบที่ AI ระบุ พร้อมข้อมูลตรวจสอบย้อนหลัง
- คะแนนความใกล้เคียงสีเป็นข้อมูล debug ไม่ใช่ความน่าจะเป็นที่ผลตรวจถูกต้อง
- ยังไม่มีการยืนยันความแม่นยำจากชุดภาพจริง และผล AI อาจเปลี่ยนแม้ใช้ภาพเดิม

ก่อนใช้โค้ดรุ่นนี้ อ่าน [ขั้นตอนอัปเดตและข้อจำกัด](docs/BUGFIX_DEPLOYMENT.md):
ต้องรัน migration ฐานข้อมูลและตั้งค่า `DASHBOARD_PASSWORD` ก่อนเปิดบริการ
