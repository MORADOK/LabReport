...
class WorkflowTests(unittest.TestCase):
    def run_workflow(self, payload):
        ...
        ns = dict(os=os, json=json, re=re, base64=base64, datetime=datetime, ALLOWED_VALUES=ALLOWED_VALUES,
                  ...
                  detect_geometry_regions=detect_geometry_regions, detect_ai_guided_regions=detect_ai_guided_regions, detect_strip_signal_regions=detect_strip_signal_regions,
