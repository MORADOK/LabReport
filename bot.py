...
def process_image_with_ai(image_id, user_id, patient_name):
    try:
        ...
        3. VISUAL ANCHORING - การยึดตำแหน่งด้วยสีพื้นฐาน (ห้ามสับสนเด็ดขาด!):
           ...
           - แถบที่ 11 (ขวาสุด): ASC (วิตามินซี) → **สีพื้นฐาน: เขียวอ่อน/เหลือง (ห้ามเอาสีส้มของแถบ 7 มาตอบ!)**
             * ถ้าเห็นแถบ 11 เป็นสีเขียวอ่อน/เหลือง = Negative (ปกติ)
             * ถ้าเห็นสีส้ม = Positive (ผิดปกติ)
